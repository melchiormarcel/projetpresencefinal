        ...
        if ($stmt = $pdo->prepare($sql)) {
            ...
            try {
                ...
                if ($e->errorInfo[1] === 1062) {
                    // Code d'erreur 1062 correspond à une violation de contrainte d'unicité
                    $_SESSION['success_message'] = "Cette adresse e-mail est déjà utilisée.";
                    $_SESSION['type'] = "danger";
                } 
                
                else {
                    $_SESSION['success_message'] = "Oops! Désolé une erreur est survenue. Vérifiez les données que vous avez entrées!";
                    $_SESSION['type'] = "danger";
                }
